...
const PromotionalBanner = () => {
    return (
        <section className="relative bg-[#5B3AEE] overflow-hidden">
            ...
            <div className="2xl:container mx-auto px-4 md:px-8 lg:px-10 py-16 md:py-20 ">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">

                    <div className="text-white">

                        <div className="mb-8">
                            <h1 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] font-extrabold leading-tight mb-4">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute inset-0 z-0">
                            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-96 h-96">
                                <svg className="w-full h-full text-yellow-400" viewBox="0 0 200 200" fill="none">
                                    <path
