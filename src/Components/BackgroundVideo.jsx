...
function BackgroundVideo() {
    return (
        <div className="2xl:container mx-auto bg-gray-50 flex items-center justify-center p-10">
            <div className="w-full max-w-6xl">
                {/* Hero Card */}
                <div className="relative bg-gradient-to-r  from-purple-500 to-purple-600 rounded-2xl overflow-hidden shadow-2xl">
                    <img className='mx-auto absolute' src="https://edutics.temptics.com/assets/img/cta-3-bg.jpg"
                        alt="" />
