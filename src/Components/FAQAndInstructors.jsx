...
const FAQAndInstructors = () => {
    ...
    const faqData = [
        {
            ...
            answer: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean scelerisque augue vitae consequat. Juisque eget congue velit in cursus leo sodales the turpis euismod quis sapien euismod quis sapien the.",
            icon: "📚"
        },
        {
    ...
    const instructors = [
        {
            ...
            achievements: ["Google Certified", "Top 1% Instructor", "10K+ Students Helped"]
        },
        {
            id: 2,
            ...
            achievements: ["Adobe Certified", "Design Award Winner", "5K+ Projects Completed"]
        },
        {
            id: 3,
            ...
            achievements: ["WordPress Contributor", "Plugin Developer", "15K+ Downloads"]
        },
        {
            id: 4,
            name: "Kristin Watson",
            ...
            achievements: ["AIGA Member", "Design Excellence Award", "8K+ Brand Projects"]
        }
    ];
    ...
    const generateAnimatedShapes = () => {
        ...
        for (let i = 0; i < 8; i++) {
            shapes.push({
                ...
                color: ['bg-yellow-300', 'bg-purple-300', 'bg-pink-300', 'bg-blue-300'][Math.floor(Math.random() * 4)]
            });
        }
    ...
    return (
        <div className="bg-white" ref={sectionRef}>
            <section className={`py-16 md:py-20 lg:py-24 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <div className="text-center lg:text-left relative">
                            ...
                            <div className="space-y-4">
                                {faqData.map((faq, index) => (
                                    <div key={index} className={`border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-md ${activeFAQ === index ? 'ring-2 ring-[#5B3AEE] ring-opacity-20' : ''}`}>
                                        <button
                                        ...
                                        >
                                            ...
                                            <svg
                                                className={`w-5 h-5 text-[#5B3AEE] transform transition-all duration-300 ${activeFAQ === index ? 'rotate-180 scale-110' : 'scale-100'}`}
                                                fill="currentColor"
                                                viewBox="0 0 24 24"
                                            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <div className="w-80 h-80 mx-auto lg:mx-0">
                                ...
                                <div className="relative w-full h-full">
                                    ...
                                    <div className="absolute top-1/4 right-1/4 flex flex-col gap-2">
                                        {[1, 2, 3].map((dot) => (
                                            <div key={dot} className={`w-2 h-2 bg-purple-400 rounded-full animate-ping`} style={{ animationDelay: `${dot * 500}ms` }}></div>
                                        ))}
                                    </div>
                                ...
                                <div className="absolute -top-4 -left-4 bg-white rounded-xl p-4 shadow-lg border border-gray-100 transform rotate-6 hover:rotate-0 transition-transform duration-300">
                                    <div className="text-center">
                                        ...
                                        <div className="text-xs font-semibold text-[#5B3AEE]">Goal</div>
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <div className="grid grid-cols-2 gap-4 md:gap-6">
                                {instructors
                                    .filter(instructor => {
                                        if (filterCategory !== "all" && instructor.category !== filterCategory) return false;
                                        if (searchTerm && !instructor.name.toLowerCase().includes(searchTerm.toLowerCase()) &&
                                            ...
                                            !instructor.expertise.some(skill => skill.toLowerCase().includes(searchTerm.toLowerCase()))) return false;
                                        return true;
                                    })
                                    .sort((a, b) => {
                                        switch (sortBy) {
                                    ...
                                    .map((instructor) => (
                                        <div
                                            key={instructor.id}
                                            className={`text-center transition-all duration-300 cursor-pointer group ${hoveredInstructor === instructor.id ? 'transform scale-105' : 'hover:scale-105'}`}
                                        ...
                                        >
                                            <div className="relative mb-3">
                                                <div className={`w-24 h-24 md:w-28 md:h-28 mx-auto ${instructor.bgColor} rounded-2xl p-2 transition-all duration-300 group-hover:shadow-lg`}>
                                                    <img
                                            ...
                                            <div className={`transition-all duration-300 ${hoveredInstructor === instructor.id ? 'max-h-32 opacity-100' : 'max-h-0 opacity-0'}`}>
                                                ...
                                                <div className="flex flex-wrap gap-1 justify-center">
                                                    {instructor.expertise.slice(0, 2).map((skill, idx) => (
                                                        <span key={idx} className="px-2 py-1 bg-[#5B3AEE] bg-opacity-10 text-white text-xs rounded-full">
                                                            {skill}
                                                        </span>
                                                    ))}
                                                </div>
                            ...
                            <div className="absolute bottom-4 right-4 w-16 h-16">
                                <svg className="w-full h-full text-yellow-400 animate-spin-slow" viewBox="0 0 100 100" fill="none">
                                    <path
                            ...
                            <div className="absolute top-8 right-8 w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                                <span className="text-white text-lg">🏆</span>
                            </div>

                            {/* Animated progress bar */}
                            <div className="absolute top-20 right-8 w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div className="h-full bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full animate-pulse" style={{ width: '75%' }}></div>
                            </div>

                            {/* Floating stats */}
                            <div className="absolute top-32 right-8 bg-white rounded-lg p-3 shadow-lg border border-gray-100">
                                <div className="text-center">
                                    <div className="text-lg font-bold text-[#5B3AEE]">500+</div>
            ...
            <section className="py-16 md:py-20 bg-white">
                <div className="2xl:container mx-auto px-4 md:px-8 lg:px-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                        {[
                            { number: "10K+", label: "Students", icon: "👨‍🎓", color: "from-blue-400 to-purple-400" },
                            { number: "500+", label: "Courses", icon: "📚", color: "from-green-400 to-blue-400" },
                            { number: "95%", label: "Success Rate", icon: "🎯", color: "from-yellow-400 to-orange-400" },
                            { number: "24/7", label: "Support", icon: "🛟", color: "from-pink-400 to-red-400" }
                        ].map((stat, index) => (
                    ...
                    <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 border-b border-gray-200">
                            <div className="flex items-center justify-between">
                                <h3 className="text-2xl font-bold text-[#241442]">Instructor Profile</h3>
                                <button
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-center gap-6 mb-6">
                                <div className={`w-24 h-24 ${selectedInstructor.bgColor} rounded-full p-3`}>
                                    <img
                                ...
                                <div className="flex-1">
                                    <h4 className="text-2xl font-bold text-[#241442] mb-2">{selectedInstructor.name}</h4>
                                    <p className="text-lg text-gray-600 mb-2">{selectedInstructor.title}</p>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="text-gray-600">{selectedInstructor.students} students</span>
                                        <span className="text-gray-500">•</span>
                                        <span className="text-gray-600">{selectedInstructor.courses} courses</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                <div className="text-center p-4 bg-gray-50 rounded-lg">
                                    <div className="text-2xl font-bold text-[#5B3AEE]">{selectedInstructor.experience}</div>
                                    <div className="text-sm text-gray-600">Experience</div>
                                </div>
                                <div className="text-center p-4 bg-gray-50 rounded-lg">
                                    <div className="text-2xl font-bold text-[#5B3AEE]">{selectedInstructor.courses}</div>
                                    <div className="text-sm text-gray-600">Courses</div>
                                </div>
                                <div className="text-center p-4 bg-gray-50 rounded-lg">
                                    <div className="text-2xl font-bold text-[#5B3AEE]">{selectedInstructor.students}</div>
                                    <div className="text-sm text-gray-600">Students</div>
                                </div>
                                <div className="text-center p-4 bg-gray-50 rounded-lg">
                                    <div className="text-2xl font-bold text-[#5B3AEE]">{selectedInstructor.languages.length}</div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {selectedInstructor.expertise.map((skill, index) => (
                                        <span key={index} className="px-3 py-2 bg-[#5B3AEE] bg-opacity-10 text-white rounded-full text-sm font-medium">
                                            {skill}
                                        </span>
                                    ))}
                                </div>
                            ...
                            {/* Achievements */}
                            <div className="mb-6">
                                <h5 className="font-semibold text-[#241442] mb-3">Achievements</h5>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex gap-3">
                                    <a href={selectedInstructor.social.linkedin} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                        </svg>
                                        LinkedIn
                                    </a>
                                    <a href={selectedInstructor.social.twitter} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-blue-400 text-white rounded-lg hover:bg-blue-500 transition-colors duration-200 flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.665 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                                        </svg>
                                        Twitter
                                    </a>
                                    <a href={selectedInstructor.social.portfolio} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-[#5B3AEE] text-white rounded-lg hover:bg-[#4A2FD8] transition-colors duration-200 flex items-center gap-2">
