...
const Footer = () => {
  ...
  return (
    <div className="2xl:container  bg-[#241442]  mx-auto mb-10">
      <div className="mx-auto w-[99%] max-w-screen-xl px-4 py-1 ">
        <div className="grid gap-6 sm:gap-8 md:gap-10 lg:gap-15 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10">
          <div className="image-container sm:col-span-full">
            ...
            <p className="text-gray-500 font-bold dark:text-gray-400">
              ...
              dicta, asperiores in quia accusantium velit exercitationem facilis
              libero veniam nostrum alias quae omnis?
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-500 font-bold dark:text-gray-400">
              ...
              <li className="mb-2">
                <Link
                  to="/about-us"
                  className="hover:text-[#F1B725] transition-colors"
                >
                  About
                </Link>
              </li>
        ...
        <div className=" mb-10 flex flex-col sm:flex-row sm:justify-between items-center">
          ...
          <div className="flex mt-4 sm:mt-0 gap-4 ">
            {SvgLogo.map(({ platform, svgPath }, index) => (
              ...
              >
                <svg
                  className="w-5 h-5 hover:fill-[#F1B725]"
                  aria-hidden="true"
