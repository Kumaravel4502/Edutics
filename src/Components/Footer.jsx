...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#241442]  mx-auto">
                ...
                <div className="grid gap-6 sm:gap-8 md:gap-10 lg:gap-15 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10">
                    <div className="image-container sm:col-span-full">
                        ...
                        <p className="text-gray-500 font-bold dark:text-gray-400">
                           Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat magni odio aliquam consequatur quis. Consequatur, possimus eveniet similique dolore veniam cum voluptates quidem. Nulla, iure, vero dicta, asperiores in quia accusantium velit exercitationem facilis libero veniam nostrum alias quae omnis?
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 font-bold dark:text-gray-400">
                            <li className="mb-2">
                                <Link to="/" className="hover:text-[#8A47CB] transition-colors">
                                    Home
                                </Link>
                            </li>
                            <li className="mb-2">
                                <Link to="/about-us" className="hover:text-[#8A47CB] transition-colors">
                                    About
                                </Link>
                            </li>
                            <li className="mb-2">
                                <Link to="/courses" className="hover:text-[#8A47CB] transition-colors">
                                    Courses
                                </Link>
                            </li>
                            <li className="mb-2">
                                <Link to="/blog" className="hover:text-[#8A47CB] transition-colors">
                                    News
                                </Link>
                            </li>
                            <li className="mb-2">
                                <Link to="/contact" className="hover:text-[#8A47CB] transition-colors">
                                    Contact
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 font-bold dark:text-gray-400">
                            <li className="mb-2">
                                <Link to="/terms-conditions" className="hover:text-[#8A47CB] transition-colors">
                                    Terms of Use
                                </Link>
                            </li>
                            <li className="mb-2">
                            ...
                            <li className="mb-2">
                                <Link to="/privacy-policy" className="hover:text-[#8A47CB] transition-colors">
                                    Privacy Policy
                                </Link>
                            </li>
                            <li className="mb-2">
                        ...
                        <div className="flex gap-4">
                            <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer">
                                <img
                                    ...
                                    alt="Play Store"
                                    className="w-32 transition-transform duration-300 hover:scale-105 cursor-pointer"
                                />
                            </a>
